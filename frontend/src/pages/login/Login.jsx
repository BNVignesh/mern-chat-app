      ...
      <div className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
        ...
        <form action="" onSubmit={handleSubmit} >
          ...
          <div>
            ...
            <input type="password" placeholder='Enter password' className='w-full input input-bordered h-10 m-2' value={password} onChange={(e) => { setPassword(e.target.value) }} />
          </div>
          <Link to="/signup" className='link link-info m-2'>Don't have an account?</Link>
